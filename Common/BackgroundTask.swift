...
class BackgroundTask {
    ...
    var timer = Timer()
    private let queue = DispatchQueue(label: "com.iaps.backgroundtask.danakit", qos: .userInitiated)
    ...
    private func playAudio() {
        queue.async { [weak self] in
            ...
            do {
                guard let bundlePath = Bundle(for: DanaKitHUDProvider.self).path(forResource: "blank", ofType: "wav") else { return }
